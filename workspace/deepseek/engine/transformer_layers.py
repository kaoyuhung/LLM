...
from engine.kernel import act_quant, weight_dequant, fp8_gemm
...
class ParallelEmbedding(nn.Module):
    ...
    def __init__(
        ...
        remainder = vocab_size % num_tp_ranks
        self.part_vocab_size = vocab_size // num_tp_ranks
        self.vocab_start_idx = tp_rank * self.part_vocab_size
        if num_tp_ranks - tp_rank <= remainder:
            self.part_vocab_size += 1
            self.vocab_start_idx += remainder - (num_tp_ranks - tp_rank)
