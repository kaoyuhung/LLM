...
class MixtralAttentionTP(nn.Module):
    """
...
# TODO @longjie no longer copied from Mistral after static cache
class MixtralFlashAttention2TP(MixtralAttentionTP):
    """
...
# TODO @longjie no longer copied from Mistral after static cache
class MixtralSdpaAttentionTP(MixtralAttentionTP):
    """
...
class MixtralSparseMoeBlockTP(nn.Module):
    """
...
MIXTRAL_ATTENTION_CLASSES = {
    "eager": MixtralAttentionTP,
    "flash_attention_2": MixtralFlashAttention2TP,
    "sdpa": MixtralSdpaAttentionTP,
}


class MixtralDecoderLayerTP(nn.Module):
    def __init__(
        self,
        config: MixtralConfig,
        layer_idx: int,
        ...
        self.block_sparse_moe = MixtralSparseMoeBlockTP(config, tp_group)
