...
def benchmark(dtype):
    ...
    input_tensor = torch.randn(512, 1024).to(device, dtype)
...
print("Testing with torch.float32:")
float32_time = benchmark(torch.float32)
print(f"Average time per iteration (float32): {float32_time:.6f} ms")
